...
if __name__ == "__main__":
    ...
    simulation_dir = '/Users/wsavran/Desktop/working/ucerf3_ridgecrest_eq/searles_valley_m71_shakemap_src/'
    plot_dir = os.path.join(simulation_dir, 'plots')
    ...
    # notebook = MarkdownReport('results_10000_mw3-mw5.ipynb')
